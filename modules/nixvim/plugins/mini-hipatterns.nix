  ...
  programs.nixvim.extraConfigLuaPre =
    lib.optionalString
      (
        ...
        && lib.hasAttr "hipatterns" config.programs.nixvim.plugins.mini.modules
      ) # Lua
      ''
      ...
      modules = {
        hipatterns = {
          highlighters = {
            ...
            fixme = {
              pattern.__raw = ''in_comment("FIXME")'';
              group = "MiniHipatternsFixme";
            };
            fix = {
              pattern.__raw = ''in_comment("FIX")'';
              group = "MiniHipatternsFixme";
            };
            hack = {
              pattern.__raw = ''in_comment("HACK")'';
              group = "MiniHipatternsHack";
            };
            todo = {
              pattern.__raw = ''in_comment("TODO")'';
              group = "MiniHipatternsTodo";
            };
            note = {
              pattern.__raw = ''in_comment("NOTE")'';
