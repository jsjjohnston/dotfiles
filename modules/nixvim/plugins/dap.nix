...
in
{
  ...
  programs.nixvim.plugins = {
    ...
    which-key.settings.spec = lib.optionals config.programs.nixvim.plugins.dap-ui.enable [
      {
        __unkeyed = "<leader>d";
        mode = "n";
        desc = "Debug";
  ...
  programs.nixvim.keymaps = lib.optionals config.programs.nixvim.plugins.dap-ui.enable [
    {
      mode = "n";
      key = "<leader>db";
      action.__raw = ''
